...
noTPP_cc_pathways <- pathway_grouping(nonTPP, group_cc)
noTPP_DDR_pathways <- pathway_grouping(nonTPP, group_DNA)
noTPP_other_pathways <- pathway_grouping(nonTPP, paste(group_cc, group_DNA, sep ="|"), exclude =T)
