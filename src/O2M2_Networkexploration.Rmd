...
### 2021_08_26_17_24_48_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep1

```{r}
load("results/2021_08_26_17_24_48_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep1.RData")

all_input_nodes <- c(transcriptomic_regulators, phosphoproteomic_regulators, TPP_cosmos_input_final_highconf$TPP_protein)

res_2021_08_26_17_24_48_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep1 = network_processing(COSMOS_object_fw2, COSMOS_object_rev2, TPP_cosmos_input_final_highconf$TPP_protein, dorothea, KSN, all_input_nodes)

p_2021_08_26_17_24_48_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep1 = visNetwork(res_2021_08_26_17_24_48_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep1$nodes, distinct(res_2021_08_26_17_24_48_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep1$combined_network)) %>%
    visGroups(groupname = "TPP_active", color = "mediumseagreen") %>%
    visGroups(groupname = "TPP_inactive", color = "palegreen") %>%
    visGroups(groupname = "TF_active", color = "#8b0a50") %>%
    visGroups(groupname = "TF_inactive", color = "palevioletred") %>%
    ...
    visOptions(highlightNearest = TRUE, nodesIdSelection = TRUE) %>%
    visLayout(randomSeed = 123)
p_2021_08_26_17_24_48_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep1

netprop_2021_08_26_17_24_48_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep1 <- network_checks(res_2021_08_26_17_24_48_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep1, TPP_cosmos_input_final_highconf$TPP_protein, transcriptomic_regulators, phosphoproteomic_regulators, dorothea, KSN)
```

### 2021_08_27_07_42_41_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep2

No optimum found even for increased time limits.

```{r}
# load("results/2021_08_27_07_42_41_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep2.RData")
# # COSMOS_object_rev2$weightedSIF <- COSMOS_object_rev1$weightedSIF
# # COSMOS_object_fw2$weightedSIF <- data.frame(Node1 = c("X11200"), Sign = c("1"), Node2 = c("X9232"), Weight = c("100"))
# 
# all_input_nodes <- c(viper_trans_top$regulator, viper_phospho_top$regulator, TPP_cosmos_input_final_highconf$TPP_protein)
# 
# 
# res_2021_08_27_07_42_41_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep2 = network_processing(COSMOS_object_fw2, COSMOS_object_rev2, TPP_cosmos_input_final_highconf$TPP_protein, dorothea, KSN, all_input_nodes)
# 
# p_2021_08_27_07_42_41_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep2 = visNetwork(res_2021_08_27_07_42_41_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep2$nodes, distinct(res_2021_08_27_07_42_41_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep2$combined_network)) %>%
#     visGroups(groupname = "TPP_active", color = "mediumseagreen") %>%
#     visGroups(groupname = "TPP_inactive", color = "palegreen") %>%
#     visGroups(groupname = "TF_active", color = "#8b0a50") %>%
#     visGroups(groupname = "TF_inactive", color = "palevioletred") %>%
...
#     visOptions(highlightNearest = TRUE, nodesIdSelection = TRUE) %>%
#     visLayout(randomSeed = 123)
# p_2021_08_27_07_42_41_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep2

# netprop_2021_08_27_07_42_41_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep2 <- network_checks(res_2021_08_27_07_42_41_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep2, TPP_cosmos_input_final_highconf$TPP_protein, transcriptomic_regulators, phosphoproteomic_regulators, dorothea, KSN)
```

### 2021_08_27_10_25_28_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep3


```{r}
# load("results/2021_08_27_10_25_28_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep3.RData")
# 
# all_input_nodes <- c(viper_trans_top$regulator, viperRes_phospho_corrected$regulator, TPP_cosmos_input_final_highconf$TPP_protein)
# 
# 
# res_2021_08_27_10_25_28_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep3 = network_processing(COSMOS_object_fw2, COSMOS_object_rev2, TPP_cosmos_input_final_highconf$TPP_protein, dorothea, KSN, all_input_nodes)
# 
# p_2021_08_27_10_25_28_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep3 = visNetwork(res_2021_08_27_10_25_28_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep3$nodes, distinct(res_2021_08_27_10_25_28_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep3$combined_network)) %>%
...
#     visOptions(highlightNearest = TRUE, nodesIdSelection = TRUE) %>%
#     visLayout(randomSeed = 123)
# p_2021_08_27_10_25_28_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep3

# netprop_2021_08_27_10_25_28_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep3 <- network_checks(res_2021_08_27_10_25_28_TPPactestNA_NAweight_highconf_adjrev_viper_COSMOSnew_rep3, TPP_cosmos_input_final_highconf$TPP_protein, transcriptomic_regulators, phosphoproteomic_regulators, dorothea, KSN)
```
...
## Montony score based input

TPP proteins detected as hit via the monotony score. Kinases and TFs same as before.

### 2021_08_27_12_46_44_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep1

In this case, the first repeat of the second run was better than the second repeat.

```{r}
load("results/2021_08_27_12_46_44_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep1.RData")
# COSMOS_object_fw2$weightedSIF <- data.frame(Node1 = c("X11200"), Sign = c("1"), Node2 = c("X9232"), Weight = c("100"))
COSMOS_object_fw2$weightedSIF <- COSMOS_object_fw1$weightedSIF

all_input_nodes <- c(transcriptomic_regulators, phosphoproteomic_regulators, TPP_cosmos_input_final_monotony$TPP_protein)

res_2021_08_27_12_46_44_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep1= network_processing(COSMOS_object_fw2, COSMOS_object_rev2, TPP_cosmos_input_final_monotony$TPP_protein, dorothea, KSN, all_input_nodes)

p_2021_08_27_12_46_44_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep1 = visNetwork(res_2021_08_27_12_46_44_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep1$nodes, distinct(res_2021_08_27_12_46_44_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep1$combined_network)) %>%
    visGroups(groupname = "TPP_active", color = "mediumseagreen") %>%
    visGroups(groupname = "TPP_inactive", color = "palegreen") %>%
    visGroups(groupname = "TF_active", color = "#8b0a50") %>%
    visGroups(groupname = "TF_inactive", color = "palevioletred") %>%
...
p_2021_08_27_12_46_44_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep1

netprop_2021_08_27_12_46_44_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep1 <- network_checks(res_2021_08_27_12_46_44_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep1, TPP_cosmos_input_final_monotony$TPP_protein, transcriptomic_regulators, phosphoproteomic_regulators, dorothea, KSN)
```

### 2021_08_27_15_45_15_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep2

In this case, the first repeat of the second run was better than the second repeat.

```{r}
load("results/2021_08_27_15_45_15_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep2.RData")
# COSMOS_object_fw2$weightedSIF <- data.frame(Node1 = c("X11200"), Sign = c("1"), Node2 = c("X9232"), Weight = c("100"))
COSMOS_object_fw2$weightedSIF <- COSMOS_object_fw1$weightedSIF

res_2021_08_27_15_45_15_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep2= network_processing(COSMOS_object_fw2, COSMOS_object_rev2, TPP_cosmos_input_final_monotony$TPP_protein, dorothea, KSN, all_input_nodes)

p_2021_08_27_15_45_15_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep2 = visNetwork(res_2021_08_27_15_45_15_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep2$nodes, distinct(res_2021_08_27_15_45_15_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep2$combined_network)) %>%
    visGroups(groupname = "TPP_active", color = "mediumseagreen") %>%
    visGroups(groupname = "TPP_inactive", color = "palegreen") %>%
    visGroups(groupname = "TF_active", color = "#8b0a50") %>%
    visGroups(groupname = "TF_inactive", color = "palevioletred") %>%
    ...
    visOptions(highlightNearest = TRUE, nodesIdSelection = TRUE) %>%
    visLayout(randomSeed = 123)
p_2021_08_27_15_45_15_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep2

netprop_2021_08_27_15_45_15_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep2 <- network_checks(res_2021_08_27_15_45_15_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep2, TPP_cosmos_input_final_monotony$TPP_protein, transcriptomic_regulators, phosphoproteomic_regulators, dorothea, KSN)
```

### 2021_08_27_17_39_00_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep3

In this case, the first repeat of the second run was better than the second repeat.

```{r}
load("results/2021_08_27_17_39_00_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep3.RData")
# COSMOS_object_fw2$weightedSIF <- data.frame(Node1 = c("X11200"), Sign = c("1"), Node2 = c("X9232"), Weight = c("100"))
COSMOS_object_fw2$weightedSIF <- COSMOS_object_fw1$weightedSIF

res_2021_08_27_17_39_00_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep3= network_processing(COSMOS_object_fw2, COSMOS_object_rev2, TPP_cosmos_input_final_monotony$TPP_protein, dorothea, KSN, all_input_nodes)

p_2021_08_27_17_39_00_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep3 = visNetwork(res_2021_08_27_17_39_00_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep3$nodes, distinct(res_2021_08_27_17_39_00_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep3$combined_network)) %>%
    visGroups(groupname = "TPP_active", color = "mediumseagreen") %>%
    visGroups(groupname = "TPP_inactive", color = "palegreen") %>%
    visGroups(groupname = "TF_active", color = "#8b0a50") %>%
    visGroups(groupname = "TF_inactive", color = "palevioletred") %>%
    ...
    visOptions(highlightNearest = TRUE, nodesIdSelection = TRUE) %>%
    visLayout(randomSeed = 123)
p_2021_08_27_17_39_00_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep3

netprop_2021_08_27_17_39_00_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep3 <- network_checks(res_2021_08_27_17_39_00_TPPactestNA_NAweight_mono_adjrev_viper_COSMOSnew_rep3, TPP_cosmos_input_final_monotony$TPP_protein, transcriptomic_regulators, phosphoproteomic_regulators, dorothea, KSN)
```
